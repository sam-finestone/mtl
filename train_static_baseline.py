...
# uncomment for both tasksrser.add_argument("--config", default='configs/medtronic_cluster/static_cityscape_config_both',
...
with mlflow.start_run():
        ...
        if TASK == 'segmentation':
            ...
            if epoch % cfg['training']['val_interval'] == 0:
                ...
                val_acc, val_loss, val_miou = static_test_single_task(epoch, criterion, val_dataloader,
                                                                      model, TASK, SAMPLES_PATH, save_val_imgs=True)
                ...
                with open(os.path.join(LOG_FILE, 'log_results.txt'), 'a') as epoch_log:
                    epoch_log.write('Validation: {}, {:.5f}, {:.5f}, {:.5f}\n'.format(epoch, val_loss, val_acc, val_miou))
            ...
            if epoch % cfg['training']['val_interval'] == 0:
                ...
                val_rel_error, val_abs_error, val_loss = static_test_single_task(epoch, criterion, val_dataloader, model,
                                                                                 TASK, SAMPLES_PATH, save_val_imgs=True)
            ...
            if epoch % cfg['training']['val_interval'] == 0:
                ...
                with open(os.path.join(LOG_FILE, 'log_results.txt'), 'a') as epoch_log:
                    epoch_log.write('Validation: {}, {:.5f}, {:.5f}, {:.5f}, {:.5f} \n'.format(epoch, val_loss,
                                                                                                val_abs_err,
                                                                                                 val_acc, val_miou))
                # Save best model to file
    ...
    #                                                              loaded_model, TASK, SAMPLES_PATH, save_val_imgs=False)
    ...
    #                                                                         loaded_model, TASK, SAMPLES_PATH,
    #                                                                         save_val_imgs=None)
