...
def plot_learning_curves(metrics, epochs, val_epochs, save_img_path, task, ):
    ...
    if task == 'segmentation':
        ...
        ax2.set_ylabel('Pix. Accuracy')
        ax2.grid()
        ax2.plot(x_train, metrics['train_acc'], color='tab:red', label='Train pix. acc.')
        ax2.plot(x_val, metrics['val_acc'], color='tab:blue', label='Val pix. acc.')
        ax3.set_xlabel('Epochs')
        ax3.set_ylabel('mIoU')
        ax3.grid()
        ax3.plot(x_val, metrics['val_miou'], color='tab:blue', label='Val mIoU')
        ax3.plot(x_train, metrics['train_miou'], color='tab:red', label='Train mIoU')
        ...
        ax2.grid()
        ax2.plot(x_train, metrics['train_abs_error'], color='tab:red', label='train abs. error')
        ...
        ax3.plot(x_val, metrics['val_miou'], color='tab:blue', label='Val mIoU')
        ax3.plot(x_val, metrics['val_acc'], color='tab:blue', linestyle='dashed', label='Val pix. acc.')
        ax3.plot(x_train, metrics['train_miou'], color='tab:red', label='Train mIoU')
        ax3.plot(x_val, metrics['val_acc'], color='tab:red', linestyle='dashed', label='Train pix. acc.')
        ax3.set_xlabel('Epochs')
        ax3.set_ylabel('mIou/Pixel Acc.')
        ax3.grid()
        # lns = ln1 + ln2 + ln3 + ln4
